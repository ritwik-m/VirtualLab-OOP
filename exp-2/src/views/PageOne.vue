...
export default {
  setup() {
    const items = ref([
      ...
      { id: 69, word: 'Exception', list: 2, dragged: false},
      { id: 700, word: 'required', list: 2, dragged: false},
      { id: 701, word: 'vehicle', list: 2, dragged: false},
      { id: 702, word: 'type', list: 2, dragged: false},
      { id: 703, word: 'is', list: 2, dragged: false},
      { id: 704, word: 'not', list: 2, dragged: false},
      { id: 705, word: 'available', list: 2, dragged: false},
      { id: 706, word: 'due', list: 2, dragged: false},
      { id: 707, word: 'to', list: 2, dragged: false},
      { id: 708, word: 'late', list: 2, dragged: false},
      { id: 709, word: 'arrivals', list: 2, dragged: false},
