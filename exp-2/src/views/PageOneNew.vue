...
export default {
  setup() {
    const items = ref([
      ...
      { id: 70, word: 'required', list: 2, dragged: false},
      { id: 71, word: 'vehicle', list: 2, dragged: false},
      { id: 72, word: 'type', list: 2, dragged: false},
      { id: 73, word: 'is', list: 2, dragged: false},
      { id: 74, word: 'not', list: 2, dragged: false},
      { id: 75, word: 'available', list: 2, dragged: false},
      { id: 76, word: 'due', list: 2, dragged: false},
      { id: 77, word: 'to', list: 2, dragged: false},
      { id: 78, word: 'late', list: 2, dragged: false},
      { id: 79, word: 'arrivals', list: 2, dragged: false},
